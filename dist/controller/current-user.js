...
var isAuthorize = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        ...
        if (!cookies.name)
            next();
        try {
            _a = jsonwebtoken_1.default.verify(cookies.token, JWTSECRET), company_id = _a.company_id, company_name = _a.company_name, email = _a.email;
