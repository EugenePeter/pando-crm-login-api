...
var getToken = function () { return __awaiter(void 0, void 0, void 0, function () {
    var URL, value, config, access_token, e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, axios_1.default.post(URL, new url_1.URLSearchParams({
            ...
            case 2:
                access_token = (_a.sent()).data.access_token;
                // console.log("ACCESS TOKEN:", access_token);
                return [2 /*return*/, access_token];
            case 3:
                e_1 = _a.sent();
                console.log("current user ERROR:", e_1);
                return [3 /*break*/, 4];
